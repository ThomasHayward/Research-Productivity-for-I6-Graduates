...
ADD FOREIGN KEY (`medical_school_id`) REFERENCES `medical_school` (`id`);

ALTER TABLE `resident`
ADD FOREIGN KEY (`residency_id`) REFERENCES `residency` (`id`);

ALTER TABLE `resident`
ADD FOREIGN KEY (`post_residency_career_id`) REFERENCES `post_residency_career` (`id`);

ALTER TABLE `resident`
ADD FOREIGN KEY (`fellowship_id`) REFERENCES `fellowship` (`id`);

ALTER TABLE `author`
ADD FOREIGN KEY (`resident_id`) REFERENCES `resident` (`id`);
